...
Create the environment from the provided requirements file. This assumes that python3.11 is in the path. Please make sure it is. If it isnt you can change it to python3.10. However, it has only been tested on these two - bot 3.9 or 3.12. 
